...
struct StaffOnboarding: View {
    ...
    let screens = [
        ...
        OnboardingScreen(
            ...
            icon: "Lab",
            description: "Handle diagnostics seamlessly",
            features: [
                "Order lab tests",
                "View test results",
    ...
    // Card transition animation (slides left, then in from right)
...
struct StaffOnboarding_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            StaffOnboarding().preferredColorScheme(.light)
            StaffOnboarding().preferredColorScheme(.dark)
            DoctorDashboard().preferredColorScheme(.light)
            DoctorDashboard().preferredColorScheme(.dark)
        }
    }
}
